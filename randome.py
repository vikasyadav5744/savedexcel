...
with tab1:
  ...
  if data!=None:
    ...
    if spot1>0:
      ...
      st.dataframe(df1, hide_index=True, width =600, height=400, column_order=['Time','CALL_LTP','CHNG','ceper','CALL_CHNG','CALL_OI','CALL_VOLUME','cvper','ceprice','STRIKE','peprice','pvper','PUT_VOLUME','PUT_OI','PUT_CHNG','peper','PCRval', 'Spot_Price','CHNG.1','PUT_LTP'], use_container_width=True)
...
with tab3:
    ...
    if newdata is not None:
        ...
        if spot2>0:
            ...
            st.dataframe(df2, hide_index=True, width =600, height=400, column_order=['Time','CALL_LTP','CHNG','ceper','CALL_CHNG','CALL_OI','CALL_VOLUME','cvper','ceprice','STRIKE','peprice','pvper','PUT_VOLUME','PUT_OI','PUT_CHNG','peper','PCRval', 'Spot_Price', 'CHNG.1','PUT_LTP'], use_container_width=True)
